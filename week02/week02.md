...
## 📌 Agenda
- Continue on the fundamentals of SQL
...
- What is [structured query language (SQL)](http://en.wikipedia.org/wiki/SQL)?
	...
	- 4GL
	- 📚 Further: [The relational model](https://en.wikipedia.org/wiki/Relational_model)
...
- 🤔 Why is it not a good idea to support removable of a column?
...
- By now you should:
	...
	- be familiar with the fundamentals of SQL including
		- CREATE, ALTER and DROP TABLE
...
## 📝 To do
- Practice SQL fundamentals with the [book](book.sql) database used in the lecture

- Be familiar with more SQLite commands

- Attend the lab

- Start / Complete TUT1 from Datacamp

- Complete A2 before the deadline
